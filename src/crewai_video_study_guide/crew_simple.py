...
class CrewaiVideoStudyGuideCrew:
    """Simple CrewAI Video Study Guide Crew without decorators"""
    
    def __init__(self):
        # Agent configurations
        self.video_engineer_config = {
    ...
    def create_agents(self):
        ...
        video_engineer = Agent(
            role=self.video_engineer_config['role'],
            goal=self.video_engineer_config['goal'],
            backstory=self.video_engineer_config['backstory'],
        ...
        content_analyzer = Agent(
            role=self.content_analyzer_config['role'],
            goal=self.content_analyzer_config['goal'],
            backstory=self.content_analyzer_config['backstory'],
            tools=[VisionTool()],
            verbose=False,
            allow_delegation=False,
            max_iter=3,
        ...
        note_synthesizer = Agent(
            role=self.note_synthesizer_config['role'],
            goal=self.note_synthesizer_config['goal'],
            backstory=self.note_synthesizer_config['backstory'],
            tools=[FileReadTool()],
            verbose=False,
            allow_delegation=False,
            max_iter=2,
        ...
        return video_engineer, content_analyzer, note_synthesizer
    
    def create_tasks(self, agents):
        """Create all tasks"""
        video_engineer, content_analyzer, note_synthesizer = agents
        ...
        return [extract_task, analysis_task, synthesis_task]
